...
//     // { href: "/drafts", label: "Drafts", icon: <FiFileText size={20} /> },
//     { href: "/bookmarks", label: "Bookmarks", icon: <FiBookmark size={20} /> },
//     // { href: "/messages", label: "Messages", icon: <FiMessageSquare size={20} /> },
...
//       {/* Header */}
//       <div className="text-xl font-bold mb-6 px-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
//         Blogify
//       </div>
...
//             {/* User Profile */}
//             <div className="flex items-center gap-3 mb-6 px-2 py-3 rounded-lg text-blue-800 bg-gray-50">
...
//             <div className="bg-gray-100 hover:bg-gray-200 transition-all rounded-lg">
//               <button
//                 onClick={() => signOut()}
//                 className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 text-sm"
//               >
...
//             <p className="text-sm text-gray-500 mb-2">Welcome, Guest 👋</p>
//             <Link
//               href="/login"
//               className="w-full text-center bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-lg transition"
//               onClick={onClose}
//             >
//               Log In
//             </Link>
//             <Link
//               href="/signup"
//               className="w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 rounded-lg transition"
//               onClick={onClose}
//             >
//               Sign Up
//             </Link>
