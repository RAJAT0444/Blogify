...
//                 loading ? 'bg-[#457b9d]/80' : 'bg-[#e63946] hover:bg-[#e63946]/90 text-[#f1faee] shadow-md hover:shadow-lg'
//               }`}
//             >
//               {loading ? (
//                 <>
...
//                         <button onClick={() => handleLike(post._id)} className="p-2 rounded-full hover:bg-[#f1faee]" aria-label="Like">
//                           <div className="flex items-center">
//                             <FiHeart
...
//                         <button onClick={() => handleBookmark(post._id)} className="p-2 rounded-full hover:bg-[#f1faee]" aria-label="Save">
//                           <FiBookmark
...
//                                 const isCurrentUser = comment.user?.email === session?.user?.email;
//                                 return (
